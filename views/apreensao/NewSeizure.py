...
class NewSeizureView(ui.View):
    ...
    @ui.button(label='Ajuda', style=discord.ButtonStyle.secondary, custom_id='help_button')
    async def help_button(self, interaction: discord.Interaction, button: ui.Button):
        ...
        await interaction.response.send_message(content='Instruções enviadas!', ephemeral=True, delete_after=15)
