...
from views.apreensao.seizure_popup import SeizureView
...
def setup_commands(bot: commands.Bot):
    ...
    async def adicionar(interaction: discord.Interaction):
        await interaction.response.send_modal(SeizureView(bot=bot, interaction=interaction, session=_new_session()))
